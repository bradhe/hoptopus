class Beer < ActiveRecord::Base
  ...
  validates_numericality_of :year, :message => "The year you supplied is out of range (#{YEAR_OF_OLDEST_BEER} - #{Time.new.year + ACCEPTED_YEARS_FROM_TODAY}) or otherwise invalid.",
                            :only_integer => true,
                            :greater_than => YEAR_OF_OLDEST_BEER,
                            :less_than => Time.new.year + ACCEPTED_YEARS_FROM_TODAY
